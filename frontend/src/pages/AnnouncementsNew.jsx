  ...
  return (
    <div>
      <div className="flex items-center justify-between mb-6">
        ...
        <button onClick={() => setShowForm((s) => !s)} className="px-3 py-2 bg-slate-900 text-white rounded-lg">
          {showForm ? 'Close' : 'Post'}
        </button>
      </div>
      ...
      {showForm && (
        <form onSubmit={handleSubmit} className="mb-6 bg-white dark:bg-slate-800 p-4 rounded-lg shadow-sm">
          ...
          <div className="mt-3 flex items-center gap-4">
            ...
            <button type="submit" disabled={submitting} className="px-4 py-2 bg-slate-900 text-white rounded">
